...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        GirlFriend girlFriend = new GirlFriend("某女友",
                "江苏省", "连云港市", "1999-11-30", "2011-04-16", "oQFk-5qtXv2uGNCu9oiCiV85KWD8");
        ...
        BoyFriend boyFriend = new BoyFriend("某男友",
                "江苏省", "连云港市", "1999-11-30", "2011-04-16", "oQFk-5qtXv2uGNCu9oiCiV85KWD8", "5t7-Ksy8_rw-QmUkxf8J7Pe-QLQ2rBc7RWJi_pSmeh4");
